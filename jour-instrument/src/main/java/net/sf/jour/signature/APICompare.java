...
public class APICompare extends APICompareChangeHelper {
	...
	public static void compare(String classpath, String signatureFileName, APICompareConfig config,
			boolean useSystemClassPath, String supportingJars) throws ChangeDetectedException {
	...
	public static List listChanges(String classpath, String signatureFileName, APICompareConfig config,
			boolean useSystemClassPath, String supportingJars) {
	...
	private void compareMethods(CtMethod[] refMethods, CtMethod[] implMethods, String className)
			throws NotFoundException {
	...
	private void compareFields(CtField[] refFields, CtField[] implFields, String className, CtClass refClass,
			CtClass implClass) throws NotFoundException {
