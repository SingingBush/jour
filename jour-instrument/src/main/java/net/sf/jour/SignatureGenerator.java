...
public class SignatureGenerator {
	...
	public static void main(String[] args) throws IOException, NotFoundException {
		...
		if ((args.length < 1) || argsp.getProperty("help") != null) {
			...
			usage.append(" --src classesDir|classes.jar (--packages com.api;com.ext) (--dst api-signature.xml)\n");
			System.out.println(usage);
			return;
		}
		Generator g = new Generator(argsp.getProperty("src"), argsp.getProperty("packages"), argsp.getProperty("dst"));
		g.process();
	}
